...
## RMBEX (International Money Transfer System)💸
...
## Bigchain POC (POC Blockchain system) 🕸️

📰 Description:
POC Blockchain system for the Singapore Government tender project using [Bigchain](https://www.bigchaindb.com/) ecosystem.
...
## Octofaya (Omnichannel Marketplace System) 💰

📰 Description:
Omnichannel marketplace for our Singapore Client [Magnetiseme](https://www.magnetiseme.com/). Octofaya is a Web & Mobile application for e-commerce sellers to manage items, stock & orders from various marketplaces inside one platform. Fully Integrated with Lazada, Shopee, Magento, Shopify & Xero Accounting.
...
📰 Description:
[Daily Act](https://jalantikus.com/news/26555/daily-act-sosial-media-baru-positif-inovatif-buatan-anak-bangsa/) is a startup company located in Tangerang, Banten with Social Media App as its main product. Like social media apps in general, Daily Act also has features such as feeds, explorer, gallery, chat, voice & video call, stories etc, kind of Instagram for short explanation.
