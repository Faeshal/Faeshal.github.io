...
So , That's all you need to know about open graph protocol , dont forget to check the documentation as always , hopefully usefull and the last but not least stay curious and never stop learning.