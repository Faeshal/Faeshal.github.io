...
Deploying **[Golang](https://go.dev/)** supposed to be very simple & straight forward, compare with other language like Java, PHP etc. I dont understand why a lot of article on the internet make looks very complicated & not straight to the point. So i write this note to give you some insight about how Golang deploy on top of Ubuntu Server with Nginx as Reverse Proxy + SSL HTTPS certificate.
